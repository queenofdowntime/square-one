...
This Slack group is for newbie coders following the Square-One guide to become
friends and learn together.

The current admin is [Claudia](https://github.com/callisto13).
...
Because this is a free slack account, we have restricted scrollback, but Slack--the company--retains complete logs of all channels and direct messages back to the creation of sq1. Slack is a U.S. company and therefore subject to subpoenas from U.S. courts. Our logs may be subject to subpoena and could become public as part of legal proceedings.
...
If you are being harassed, notice that someone else is being harassed, or have any other concerns, please contact the admin. They'll respond as promptly as they can.
